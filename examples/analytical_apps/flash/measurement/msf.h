...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_MSF_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_MSF_H_
...
class MSFFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_MSF_H_
