...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_MM_OPT_2_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_MM_OPT_2_H_
...
class MMOpt2Flash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_MM_OPT_2_H_
