...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_MM_OPT_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_MM_OPT_H_
...
class MMOptFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_MM_OPT_H_
