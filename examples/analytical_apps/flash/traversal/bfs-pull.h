...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_BFS_PULL_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_BFS_PULL_H_
...
class BFSPullFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_BFS_PULL_H_
