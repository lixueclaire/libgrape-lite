...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_BFS_UNDIRECTED_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_BFS_UNDIRECTED_H_
...
class BFSUndirectedFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
  ...
  void Run(const fragment_t& graph, vid_t source) {
    Print("Run BFS-undirected with Flash, source = %d\n", source);
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_UNDIRECTED_H_
