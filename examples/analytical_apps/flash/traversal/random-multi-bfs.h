...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_RANDOM_MULTI_BFS_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_RANDOM_MULTI_BFS_H_
...
class RandomMultiBFSFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
  ...
  void Run(const fragment_t& graph) {
    Print("Run random multi-source BFS with Flash, ");
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_RANDOM_MULTI_BFS_H_
