...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_SSSP_DLT_STEP_UNDIRECTED_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_SSSP_DLT_STEP_UNDIRECTED_H_
...
class SSSPDltStepUndirectedFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
  ...
  void Run(const fragment_t& graph, vid_t source) {
    Print("Run undirected delta-stepping SSSP with Flash, source = %d\n", source);
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_SSSP_DLT_STEP_UNDIRECTED_H_
