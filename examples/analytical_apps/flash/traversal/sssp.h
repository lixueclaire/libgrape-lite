...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_SSSP_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_SSSP_H_
...
class SSSPFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
  ...
  void Run(const fragment_t& graph, vid_t source) {
    Print("Run SSSP with Flash, source = %d\n", source);
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_SSSP_H_
