...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_CC_PUSH_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_CC_PUSH_H_
...
class CCPushFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_CC_PUSH_H_
