...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_CC_PULL_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_CC_PULL_H_
...
class CCPullFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_CC_PULL_H_
