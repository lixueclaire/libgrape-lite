...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_KATZ_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_KATZ_H_
...
class KATZFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
  ...
  void Run(const fragment_t& graph) {
    Print("Run katz-centrality with Flash, ");
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_KATZ_H_
