...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_HARMONIC_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_HARMONIC_H_
...
class HarmonicFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
  ...
  void Run(const fragment_t& graph) {
    Print("Run harmonic-centrality with Flash, ");
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_HARMONIC_H_
