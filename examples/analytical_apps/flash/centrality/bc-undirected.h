...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_BC_UNDIRECTED_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_BC_UNDIRECTED_H_
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_BC_UNDIRECTED_H_
