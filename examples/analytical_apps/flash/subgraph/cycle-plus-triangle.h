...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_CYCLE_PLUS_TRIANGLE_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_CYCLE_PLUS_TRIANGLE_H_
...
class CyclePlusTriangleFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
  ...
  void Run(const fragment_t& graph) {
    Print("Run Cycle+ Triangle Counting with Flash, ");
    ...
    GetSum(cnt, cnt_all);
    Print( "number of cycle+ triangles=%lld\n", cnt_all);
	}
};
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_CYCLE_PLUS_TRIANGLE_H_
