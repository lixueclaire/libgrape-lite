...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_THREE_PATH_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_THREE_PATH_H_
...
class ThreePathFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
  ...
  void Run(const fragment_t& graph) {
    Print("Run 3-path Counting with Flash, ");
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_THREE_PATH_H_
