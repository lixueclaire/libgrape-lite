...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_RECTANGLE_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_RECTANGLE_H_
...
class RectangleFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_RECTANGLE_H_
