...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_OUT_TRIANGLE_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_OUT_TRIANGLE_H_
...
class OutTriangleFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
  ...
  void Run(const fragment_t& graph) {
    Print("Run Out+ Triangle Counting with Flash, ");
    ...
    GetSum(cnt, cnt_all);
    Print( "number of out+ triangles=%lld\n", cnt_all);
	}
};
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_OUT_TRIANGLE_H_
