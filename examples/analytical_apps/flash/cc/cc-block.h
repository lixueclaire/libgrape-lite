...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_CC_BLOCK_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_CC_BLOCK_H_
...
class CCBlockFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_CC_BLOCK_H_
