...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_CC_UNION_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_CC_UNION_H_
...
class CCUnionFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
  ...
  void Run(const fragment_t& graph) {
    ...
    Print("Run CC-Union with Flash, total vertices: %d\n", n_vertex);
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_CC_UNION_H_
