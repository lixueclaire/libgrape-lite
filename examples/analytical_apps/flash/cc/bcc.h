...
#ifndef EXAMPLES_ANALYTICAL_APPS_FLASH_BCC_H_
#define EXAMPLES_ANALYTICAL_APPS_FLASH_BCC_H_
...
class BCCFlash : public FlashAppBase<FRAG_T, VALUE_T> {
 public:
...
#endif  // EXAMPLES_ANALYTICAL_APPS_FLASH_BCC_H_
